...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__employees_employee_employee_component__ = __webpack_require__("./src/app/employees/employee/employee.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__employees_employee_list_employee_list_component__ = __webpack_require__("./src/app/employees/employee-list/employee-list.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["G" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__employees_employee_employee_component__["a" /* EmployeeComponent */],
                __WEBPACK_IMPORTED_MODULE_11__employees_employee_list_employee_list_component__["a" /* EmployeeListComponent */]
            ],
            imports: [
...
module.exports = "<div class=\"text-left\">\n  <form #employeeForm=\"ngForm\" (ngSubmit)=\"onSubmit(employeeForm)\">\n      <input type=\"hidden\" class=\"form-control\" name=\"$key\" #$key=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.$key\">\n    <div class=\"form-group\">\n      <label>Name</label>\n      <input class=\"form-control\" name=\"name\" #name=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.name\" placeholder=\"Full Name of Employee\" required>\n    </div>\n    <div class=\"form-group\">\n      <label>Position</label>\n      <input class=\"form-control\" name=\"position\" #position=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.position\" placeholder=\"Position\" required>\n    </div>\n    <div class=\"form-group\">\n      <label>Office</label>\n      <input class=\"form-control\" name=\"office\" #name=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.office\" placeholder=\"Office\" required>\n    </div>\n    <div class=\"form-group\">\n      <label>Salary</label>\n      <div class=\"input-group\">\n        <div class=\"input-group-addon\">\n          <i class=\"fas fa-hand-holding-usd\"></i>\n        </div>\n        <input class=\"form-control\" name=\"salary\" #salary=\"ngModel\" [(ngModel)]=\"employeeService.selectedEmployee.salary\" placeholder=\"Salary\" required>\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <button class=\"btn btn-success\" type=\"submit\" [disabled]=\"!employeeForm.valid\"><i class=\"fas fa-save\"></i> Submit</button>\n      <button class=\"btn btn-danger\" (click)=\"resetForm(employeeForm)\"><i class=\"fas fa-redo-alt\"></i> Reset</button>\n    </div>\n  </form>\n</div>"
...
var EmployeeComponent = /** @class */ (function () {
    ...
    EmployeeComponent.prototype.onSubmit = function (employeeForm) {
        ...
        this.tostr.success('SUBMITED SUCCESSFULLY', 'Employee Register');
    };
...
var environment = {
    production: true,
    firebaseConfig: {
        apiKey: "AIzaSyD0PNyODe5VCqBKCoc3uMlWxBJTpTtmbiY",
        authDomain: "angular5crud-eb087.firebaseapp.com",
        databaseURL: "https://angular5crud-eb087.firebaseio.com",
        projectId: "angular5crud-eb087",
        storageBucket: "angular5crud-eb087.appspot.com",
        messagingSenderId: "34014805604"
    }
};
